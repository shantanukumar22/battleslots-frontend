          ...
          <div className="container mx-auto px-6">
            <div className="max-w-2xl relative">
              ...
              <p className="text-lg text-gray-100 mb-6">
                Secure your spot and compete with the best players!
              </p>
              <button
                onClick={() =>
                  window.scrollTo({ top: 400, behavior: "smooth" })
                }
                className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-bold flex items-center gap-2 shadow-lg"
              >
                VIEW SLOTS
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={refreshTimeSlots}
            disabled={isRefreshing}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md flex items-center gap-2 shadow-md"
          >
            <RefreshCw
              size={18}
              className={isRefreshing ? "animate-spin" : ""}
            ...
            {timeSlots.map((slot) => (
              ...
              >
                ...
                <div className="flex items-center text-gray-300 mb-4">
                  ...
                  {slot.players.length}/10 Players
                </div>
                ...
                <div className="flex justify-end">
                  {slot.isResultDeclared ? (
                    ...
                    <button
                      disabled
                      className="px-4 py-2 bg-red-800 text-white rounded-md cursor-not-allowed"
                    >
                      Full
                    </button>
                  ) : (
        ...
        {/* Rewards & Payouts */}
        <div className="mt-16 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-8 shadow-lg">
          ...
          <ul className="text-gray-300 space-y-2 mb-6">
            ...
            <li>🥈 2nd Prize — ₹110</li>
            <li>🥉 3rd Prize — ₹100</li>
            <li>🎖️ 4th Prize — ₹80</li>
            <li>🎖️ 5th Prize — ₹70</li>
            <li>🎖️ 6th Prize — ₹60</li>
            <li>🎖️ 7th Prize — ₹55</li>
          </ul>
          <p className="text-sm text-gray-400 italic">
            ⚠️ A TDS of 30% is applicable on net winnings as per Income Tax Act.
          </p>
        </div>
      </div>
